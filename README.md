...
3. Run the model using the provided examples:
   ...
   - Checkerboard Method:
     ...
     - Before running the notebook, download the example video from [this Google Drive link](https://drive.google.com/drive/u/1/folders/1xCasZSRDQwJzxzs-_qgVZaTP7_6k07I6) and place it in a local directory (in this example, <em>make sure that you use the black and white video</em>).
